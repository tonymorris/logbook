...
import Control.Lens
import Data.Aviation.Casr.Logbook.Types.Aircraft.Propulsion.InternalCombustionEngineAirInduction(InternalCombustionEngineAirInduction, InternalCombustionEngineAirInduction_, HasInternalCombustionEngineAirInduction(internalCombustionEngineAirInduction))
import Data.Aviation.Casr.Logbook.Types.Aircraft.Propulsion.InternalCombustionEngineFuelInduction(InternalCombustionEngineFuelInduction, InternalCombustionEngineFuelInduction_, HasInternalCombustionEngineFuelInduction(internalCombustionEngineFuelInduction))
import Data.Aviation.Casr.Logbook.Types.Aircraft.Propulsion.InternalCombustionEngineIgnition(InternalCombustionEngineIgnition, InternalCombustionEngineIgnition_, HasInternalCombustionEngineIgnition(internalCombustionEngineIgnition))
import Data.Aviation.Casr.Logbook.Types.Aircraft.Propulsion.InternalCombustionEngineType(InternalCombustionEngineType, InternalCombustionEngineType_, HasInternalCombustionEngineType(internalCombustionEngineType))
